...
export function CreateMessageForm() {
  ...
  return (
    <form action={createMessageAction} className='flex gap-2 bg-zinc-900 p-2 rounded-xl border border-zinc-800 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-1'>
      <input
        type="text"
        name='theme'
